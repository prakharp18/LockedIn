...
export default function Stats({ onBack }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black to-[#0f0f1a] text-white px-4 py-6 font-heading">
      <button
        onClick={onBack}
      ...
      <div className="text-center mb-4">
        <h2 className="text-3xl font-bold mb-1">Statistics</h2>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {/* Radial Chart */}
        <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl px-4 py-3 h-[300px]">
        ...
        {/* Bar Chart */}
        <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl px-4 py-4">
